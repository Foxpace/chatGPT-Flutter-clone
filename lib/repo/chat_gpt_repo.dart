...
class ChatGptRepo implements ChatRepo {
  ...
  static const systemRole = {"role": "system", "content": roleDescription};
  ...
  @override
  Future<ChatMessage> getResponse(List<ChatMessage> messages) async {
    final body = {
    ...
    try {
      ...
      throw Exception(
          "Failed to parse the response: ${response.body} due to: $e");
    }
